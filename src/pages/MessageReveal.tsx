...
export default function MessageReveal() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "radial-gradient(ellipse at 50% 35%, #16120a 0%, #0c0b08 45%, #050505 100%)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ position: "fixed", inset: 0, pointerEvents: "none", zIndex: 0, opacity: 0.05, backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='2' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)'/%3E%3C/svg%3E")` }} />
        ...
        {!revealed ? (
          ...
          <div className="letter-card" style={{ maxWidth: 480, width: "100%" }}>
            ...
            <div style={{
              padding: "3px",
              borderRadius: "18px",
              background: "linear-gradient(135deg, #8a6d2b 0%, #e8c96a 25%, #c9a84c 50%, #f5d07a 75%, #8a6d2b 100%)",
              boxShadow: "0 0 40px rgba(201,168,76,0.18), 0 0 90px rgba(201,168,76,0.07)",
            }}>
              <div style={{
                background: "#111111",
                borderRadius: "15px",
                ...
                <div style={{ padding: "32px 32px 32px" }}>
                  ...
                  <p className={useDropCap ? "drop-cap" : undefined} style={{
                    fontFamily: "'Cormorant Garamond', Georgia, serif",
                    fontSize: 25,
                    fontWeight: 500,
                    lineHeight: 1.7,
